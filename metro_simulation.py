...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List['Istasyon']]:
        ...
        ziyaret_edildi = set()
        kuyruk = deque([(baslangic, [baslangic])])  # (mevcut_istasyon, rota_listesi)
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List['Istasyon'], int]]:
        ...
        # (toplam_sure, benzersiz_id, istasyon, rota_listesi)
        ...
        while pq:
            ...
            # Daha önce daha kısa sürede gidildiyse tekrar işleme
        ...
        return None  # Rota bulunamadıysa
